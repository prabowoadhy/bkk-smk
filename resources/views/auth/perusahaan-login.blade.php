    ...
    <div class="container">
        <div class="row py-5 mt-0 align-items-top">
            ...
            <div class="col-md-7 col-lg-6 ml-auto">
                <h4 class="text-primary mb-4">Login Perusahaan</h4>
                <form action="#">
                    <div class="row">
                        <!-- Email Address -->
                        ...
                        <div class="form-group col-lg-12 mx-auto mb-0">
                            <a href="/perusahaan-profil" class="btn btn-primary btn-block py-2">
                        ...
                        <div class="text-center w-100">
                            <p class="text-muted font-weight-bold">Not yet Registered? <a href="/perusahaan-registrasi" class="text-primary ml-2">Register</a></p>
                        </div>
