        ...
        <div class="row">
            <div class="col-md-9 p-2">
                <div class="card-group">
                    <div class="card">
                      <img src="assets/img/portfolio/cabin.png" class="card-img-top img-thumbnail" alt="...">
                      <div class="card-body">
                    ...
                    <div class="card">
                      <img src="assets/img/portfolio/cake.png" class="card-img-top" alt="...">
                      <div class="card-body">
                    ...
                    <div class="card">
                      <img src="assets/img/caption-thumb.png" class="card-img-top img-fluid" alt="...">
                      <div class="card-body">
